...
namespace Omnisend\FormidableFormsAddon\Builder;
 ...
 */
class RequestBodyBuilder {
	private const FORM_NAME_REGEX = '/[^A-Za-z0-9\-]/';
	...
	public function get_body( array $mapped_fields, string $form_name ): array {
		...
		$form_name      = preg_replace( self::FORM_NAME_REGEX, '', $form_name );
		$consent_object = array(
			'source'    => 'formidable-forms-' . $form_name,
			'createdAt' => gmdate( 'c' ),
